...
//
// found here:
// https://github.com/DinoChiesa/XPathVisualizer/blob/master/XPathVisualizer/CustomControls/RichTextBoxEx.cs
...
namespace TinyPG.Controls
{
	...
	public class RichTextBoxEx : RichTextBox
	{
		...
		private Point GetPosFromCharIndex(int ix)
		{
			...
			int r = User32.SendMessage(this.Handle, (int)User32.Msgs.EM_POSFROMCHAR, wParam, ix);
