...
namespace TinyPG
{
	...
	protected:
		...
		inline void ParseAddExpr(ParseNode* parent) // NonTerminalSymbol: AddExpr
		{
			Token tok;
			ParseNode* n;
		...
		inline void ParseMultExpr(ParseNode* parent) // NonTerminalSymbol: MultExpr
		{
			Token tok;
			ParseNode* n;
		...
		inline void ParseAtom(ParseNode* parent) // NonTerminalSymbol: Atom
		{
			Token tok;
			ParseNode* n;
