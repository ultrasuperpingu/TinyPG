...
namespace TinyExe
{
	...
	public:
		...
		void InitDefaults()
		{
			...
			/*this->insert(std::make_pair(std::string("about"), new StaticFunction("About", delegate(object[] ps) { return "@TinyExe - a Tiny Expression Evaluator v1.0\r\nby Herre Kuijpers - Copyright © 2011 under the CPOL license"; }, 0, 0)));
			this->insert("help", new StaticFunction("Help", Help, 0, 0));
