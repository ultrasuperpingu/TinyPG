...
namespace TinyExe
{
	...
	protected:
		...
		inline void ParseFunction(ParseNode* parent) // NonTerminalSymbol: Function
		{
			Token tok;
			ParseNode* n;
		...
		inline void ParsePrimaryExpression(ParseNode* parent) // NonTerminalSymbol: PrimaryExpression
		{
			Token tok;
			ParseNode* n;
		...
		inline void ParseParenthesizedExpression(ParseNode* parent) // NonTerminalSymbol: ParenthesizedExpression
		{
			Token tok;
			ParseNode* n;
		...
		inline void ParseUnaryExpression(ParseNode* parent) // NonTerminalSymbol: UnaryExpression
		{
			Token tok;
			ParseNode* n;
		...
		inline void ParsePowerExpression(ParseNode* parent) // NonTerminalSymbol: PowerExpression
		{
			Token tok;
			ParseNode* n;
		...
		inline void ParseMultiplicativeExpression(ParseNode* parent) // NonTerminalSymbol: MultiplicativeExpression
		{
			Token tok;
			ParseNode* n;
		...
		inline void ParseAdditiveExpression(ParseNode* parent) // NonTerminalSymbol: AdditiveExpression
		{
			Token tok;
			ParseNode* n;
		...
		inline void ParseConcatEpression(ParseNode* parent) // NonTerminalSymbol: ConcatEpression
		{
			Token tok;
			ParseNode* n;
		...
		inline void ParseRelationalExpression(ParseNode* parent) // NonTerminalSymbol: RelationalExpression
		{
			Token tok;
			ParseNode* n;
		...
		inline void ParseEqualityExpression(ParseNode* parent) // NonTerminalSymbol: EqualityExpression
		{
			Token tok;
			ParseNode* n;
		...
		inline void ParseConditionalAndExpression(ParseNode* parent) // NonTerminalSymbol: ConditionalAndExpression
		{
			Token tok;
			ParseNode* n;
		...
		inline void ParseConditionalOrExpression(ParseNode* parent) // NonTerminalSymbol: ConditionalOrExpression
		{
			Token tok;
			ParseNode* n;
		...
		inline void ParseAssignmentExpression(ParseNode* parent) // NonTerminalSymbol: AssignmentExpression
		{
			Token tok;
			ParseNode* n;
		...
		inline void ParseExpression(ParseNode* parent) // NonTerminalSymbol: Expression
		{
			Token tok;
			ParseNode* n;
		...
		inline void ParseParams(ParseNode* parent) // NonTerminalSymbol: Params
		{
			Token tok;
			ParseNode* n;
		...
		inline void ParseLiteral(ParseNode* parent) // NonTerminalSymbol: Literal
		{
			Token tok;
			ParseNode* n;
		...
		inline void ParseIntegerLiteral(ParseNode* parent) // NonTerminalSymbol: IntegerLiteral
		{
			Token tok;
			ParseNode* n;
		...
		inline void ParseRealLiteral(ParseNode* parent) // NonTerminalSymbol: RealLiteral
		{
			Token tok;
			ParseNode* n;
		...
		inline void ParseStringLiteral(ParseNode* parent) // NonTerminalSymbol: StringLiteral
		{
			Token tok;
			ParseNode* n;
		...
		inline void ParseVariable(ParseNode* parent) // NonTerminalSymbol: Variable
		{
			Token tok;
			ParseNode* n;
