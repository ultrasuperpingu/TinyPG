...
namespace TinyPG.CodeGenerators.VBNet
{
	public class ScannerGenerator : BaseGenerator, ICodeGenerator
	{
		...
		public string Generate(Grammar Grammar, bool Debug)
		{
			...
			// build system tokens
			tokentype.AppendLine("\r\n" + Helper.Indent2 +"'Non terminal tokens:");
			...
			tokentype.AppendLine("\r\n" +  Helper.Indent2 +"'Terminal tokens:");
			bool first = true;
			foreach (TerminalSymbol s in Grammar.GetTerminals())
			{
				...
				regexps.Append(Helper.Indent3 + "regex = new Regex(" + vbexpr + ", RegexOptions.Compiled)\r\n");
				regexps.Append(Helper.Indent3 + "Patterns.Add(TokenType." + s.Name + ", regex)\r\n");
